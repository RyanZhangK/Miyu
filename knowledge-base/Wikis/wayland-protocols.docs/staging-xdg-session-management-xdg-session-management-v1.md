...
## Interface `xdg_session_manager_v1` version 1
...
- `get_session`: create or restore a session
  ...
  Arguments: `id` (new_id); `reason` (uint) - reason for session; `session_id` (string) - the session to restore

### Enums

- `error`
- `reason`: reason for getting a session
...
## Interface `xdg_session_v1` version 1
...
- `add_toplevel`: add a new surface to the session
  ...
  Arguments: `id` (new_id); `toplevel` (object); `name` (string) - name identifying the toplevel
- `restore_toplevel`: restore a surface state
  ...
  Arguments: `id` (new_id); `toplevel` (object); `name` (string) - name identifying the toplevel
- `remove_toplevel`: remove a surface from the session
  ...
  Arguments: `name` (string) - name identifying the toplevel

### Events

- `created`: newly-created session id
...
- `replaced`: the session has been replaced
...
## Interface `xdg_toplevel_session_v1` version 1
...
- `rename`: change the name of toplevel session
  ...
  Arguments: `name` (string) - new name to identify the toplevel

### Events

- `restored`: a toplevel's session has been restored
