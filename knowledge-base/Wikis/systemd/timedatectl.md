...
**set-time \[TIME\]**  
Set the system clock to the specified timestamp. This will also update the RTC time accordingly. The timestamp may be specified in the format "`2012-10-30 18:17:16`". See systemd.time(7) for more details about acceptable timestamp format.
