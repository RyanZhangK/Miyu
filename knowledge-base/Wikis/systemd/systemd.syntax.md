...
| "`\s`" | space |
| "`\x`*`xx`*" | character number *`xx`* in hexadecimal encoding |
| "`\`*`nnn`*" | character number *`nnn`* in octal encoding |
| "`\u`*`nnnn`*" | unicode code point *`nnnn`* in hexadecimal encoding |
| "`\U`*`nnnnnnnn`*" | unicode code point *`nnnnnnnn`* in hexadecimal encoding |
