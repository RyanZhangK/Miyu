...
Whenever the system locale or keymap is changed via the daemon, `PropertyChanged` signals are sent out to clients which have subscribed.
...
systemd(1), systemd-localed.service(8), localectl(1)
