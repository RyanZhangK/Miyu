...
**health \[ -a agno\] \[ -c \] \[ -f \] \[ -i inum \] \[ -n \] \[ -q \] \[ -r rgno \] \[ paths \]**
...
**-n**
When reporting on the health of a file, try to report the full file path, if possible. This option is disabled by default to minimize runtime.
