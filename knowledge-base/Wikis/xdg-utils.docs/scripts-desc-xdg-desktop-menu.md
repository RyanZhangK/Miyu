...
`xdg-desktop-icon(1)`, `xdg-icon-resource(1)`, `xdg-mime(1)`, `xdg-utils-common(7)`, [Desktop entry specification](http://www.freedesktop.org/wiki/Specifications/desktop-entry-spec/), [Desktop menu specification](http://www.freedesktop.org/wiki/Specifications/menu-spec/)
