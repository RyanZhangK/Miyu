...
The *query filetype* option is for use inside a desktop session only. It is not recommended to use xdg-mime query filetype as root.
...
`xdg-icon-resource(1)`, `xdg-desktop-menu(1)`, `xdg-utils-common(7)`, [Shared MIME database specification](http://www.freedesktop.org/wiki/Specifications/shared-mime-info-spec/), [MIME applications associations specification](http://www.freedesktop.org/wiki/Specifications/mime-apps-spec/)
