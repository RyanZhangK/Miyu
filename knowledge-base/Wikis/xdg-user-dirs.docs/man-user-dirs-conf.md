...
The `/etc/xdg/user-dirs.conf` file is a text file that controls the behavior of the xdg-user-dirs-update command. Users can have their own `$HOME/.config/user-dirs.conf` file, which overrides the system-wide configuration.
