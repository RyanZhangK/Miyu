...
The locations where WirePlumber searches for scripts is explained in `config_locations_scripts`.

Scripts are not loaded automatically; a component muse be defined for them, and this component must be included in a profile. See `config_components_and_profiles`.
