...
Opens a LogTopic with the given topic name. Well known script topics are described in `daemon_logging`, and messages from scripts shall use **s-**\*.
...
param object  
optional object to associate the message with; you may skip this and just start with the *message* as the first parameter
