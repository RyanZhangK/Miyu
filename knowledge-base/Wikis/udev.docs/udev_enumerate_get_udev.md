...
`udev_enumerate_scan_devices()`, `udev_enumerate_scan_subsystems()`, `udev_enumerate_get_list_entry()`, `udev_enumerate_add_syspath()`, and `udev_enumerate_get_udev()` were added in version 221.
