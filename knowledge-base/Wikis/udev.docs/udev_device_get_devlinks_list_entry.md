...
`udev_device_get_devlinks_list_entry()`, `udev_device_get_properties_list_entry()`, `udev_device_get_tags_list_entry()`, `udev_device_get_sysattr_list_entry()`, `udev_device_get_property_value()`, `udev_device_has_tag()`, `udev_device_get_sysattr_value()`, and `udev_device_set_sysattr_value()` were added in version 221.

`udev_device_has_current_tag()` and `udev_device_get_current_tags_list_entry()` were added in version 247.
