...
Official verb lists generated by the Winetricks project.
...
- `busybox` - BusyBox FRP-5579-g5749feb35 (Ron Yorston / Busybox authors, 2025) [downloadable]
...
- `dinputto8` - A dll module that is designed to improve compatibility in games using DirectInput 1-7 by converting all API calls to their equivalent DirectInput 8 (1.0.92.0) (Elisha Riedlinger, 2018) [downloadable]
...
- `dotnet10` - MS .NET Runtime 10.0 LTS (Microsoft, 2025) [downloadable]
...
- `dotnetdesktop10` - MS .NET Desktop Runtime 10.0 LTS (Microsoft, 2025) [downloadable]
...
- `dsoal` - A DirectSound DLL replacer that enables surround sound, HRTF, and EAX support via OpenAL Soft (kcat, 2019) [downloadable]
...
- `dxvk2053` - Vulkan-based D3D8/D3D9/D3D10/D3D11 implementation for Linux / Wine (2.5.3) (Philip Rebohle, 2025) [downloadable]
- `dxvk2060` - Vulkan-based D3D8/D3D9/D3D10/D3D11 implementation for Linux / Wine (2.6) (Philip Rebohle, 2025) [downloadable]
- `dxvk2061` - Vulkan-based D3D8/D3D9/D3D10/D3D11 implementation for Linux / Wine (2.6.1) (Philip Rebohle, 2025) [downloadable]
- `dxvk2062` - Vulkan-based D3D8/D3D9/D3D10/D3D11 implementation for Linux / Wine (2.6.2) (Philip Rebohle, 2025) [downloadable]
- `dxvk2070` - Vulkan-based D3D8/D3D9/D3D10/D3D11 implementation for Linux / Wine (2.7) (Philip Rebohle, 2025) [downloadable]
- `dxvk2071` - Vulkan-based D3D8/D3D9/D3D10/D3D11 implementation for Linux / Wine (2.7.1) (Philip Rebohle, 2025) [downloadable]
- `dxvk_async` - DXVK with Async and GPL patches [USE AT OWN RISK IN GAMES WITH ANTICHEAT] (latest) (Ph42oN, 2025) [downloadable]
- `dxvk_nvapi` - Alternative NVAPI Vulkan implementation on top of DXVK for Linux / Wine (latest) (Jens Peters, 2025) [downloadable]
- `dxvk_nvapi0061` - Alternative NVAPI Vulkan implementation on top of DXVK for Linux / Wine (0.6.1) (Jens Peters, 2023) [downloadable]
- `dxvk_nvapi009` - Alternative NVAPI Vulkan implementation on top of DXVK for Linux / Wine (0.9.0) (Jens Peters, 2025) [downloadable]
...
- `galliumnine` - Gallium Nine Standalone (latest) (Gallium Nine Team, 2024) [downloadable]
- `galliumnine010` - Gallium Nine Standalone (v0.10) (Gallium Nine Team, 2024) [downloadable]
...
- `physx` - PhysX (Nvidia, 2024) [downloadable]
...
- `vcrun2026` - Visual C++ 2017-2026 libraries (concrt140.dll,mfc140.dll,mfc140chs.dll,mfc140cht.dll,mfc140deu.dll,mfc140enu.dll,mfc140esn.dll,mfc140fra.dll,mfc140ita.dll,mfc140jpn.dll,mfc140kor.dll,mfc140rus.dll,mfc140u.dll,mfcm140.dll,mfcm140u.dll,msvcp140.dll,msvcp140_1.dll,msvcp140_2.dll,msvcp140_atomic_wait.dll,msvcp140_codecvt_ids.dll,vcamp140.dll,vccorlib140.dll,vcomp140.dll,vcruntime140.dll,vcruntime140_1.dll) (Microsoft, 2026) [downloadable]
...
- `theme=dark` - Use dark theme for the WINEPREFIX
- `theme=light` - Use default Wine theme (light) for the WINEPREFIX
- `useegl=n` - Disable EGL, use GLX instead
- `useegl=y` - Enable EGL (default)
