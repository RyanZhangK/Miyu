...
- [ICD Loader](loader/)
- [Loader Documentation](docs/loader-interfacearchitecture.md)
- [Tests](tests/)
...
Architecture and interface information for the loader is in [docs/loader-interfacearchitecture.md](docs/loader-interfacearchitecture.md).
