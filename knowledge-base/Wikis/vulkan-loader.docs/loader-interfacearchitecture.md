...
The [Override Meta-Layer](./loader-layerinterface.md#override-meta-layer) is
...
`vkGetDeviceProcAddr`.
See
[Best Application Performance Setup](loader-applicationinterface.md#best-application-performance-setup)
section in the
[loader-applicationinterface.md](loader-applicationinterface.md) document for more
information on this.
...
[Layer Discovery](loader-layerinterface.md#layer-discovery) and
[Driver Discovery](loader-driverinterface.md#driver-discovery).
<br/>
<br/>
...
[loader-applicationinterface.md](loader-applicationinterface.md) document found in
...
[loader-layerinterface.md](loader-layerinterface.md) document found in the same
...
[loader-driverinterface.md](loader-driverinterface.md) document found in the same
directory as this file.
<br/>
<br/>
...
These are detailed in the [loader-debugging.md](loader-debugging.md) document
 ...
 * [Loader And Driver Policy](loader-driverinterface.md#loader-and-driver-policy)
 * [Loader And Layer Policy](loader-layerinterface.md#loader-and-layer-policy)
<br/>
<br/>
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>The <b>Layer Library</b> is the group of all layers the loader is able
        ...
        some way.
        For more info, see
        <a href="loader-layerinterface.md#layer-layer-discovery">Layer Discovery
        </a>.
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Data files in JSON format used by the Khronos loader.
        ...
        <a href="loader-layerinterface.md#layer-manifest-file-format">Layer</a>
        or a
        <a href="loader-driverinterface.md#driver-manifest-file-format">Driver</a>
  ...
  <tr>
    ...
    <td>Acronym for Windowing System Integration.
        ...
        See
        <a href="loader-applicationinterface.md#wsi-extensions">WSI Extensions</a>
